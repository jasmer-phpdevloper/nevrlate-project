    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs"> {userDetails?.userType || ''} user </span>
        </span>

        <span className="h-12 w-12 rounded-full">
      
          <img src={userDetails.avatar || UserOne} alt="User" className='w-10 h-10 rounded-full' />
        </span>
      ...
      >
        ...
        <button className="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 
        ease-in-out hover:text-primary lg:text-base"  onClick={handleLogout}>
          <svg
            className="fill-current"
            width="22"
            height="22"
